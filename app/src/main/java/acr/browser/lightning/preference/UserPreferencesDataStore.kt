...
class UserPreferencesDataStore @Inject constructor(
        ...
        migrations = listOf(
            SharedPreferencesMigration(
                ...
                (preferences.toMutablePreferences() to sharedPreferences).apply {
                    ...
                    migrateBoolean(roomMigrationComplete)
                }.first
            }
        ),
        produceFile = {
    ...
    /**
     * True if the migration from SQLite to Room has been completed.
     */
    val roomMigrationComplete: NonNullPreferenceStore<Boolean> = NonNullPreferenceStore(
        key = booleanPreferencesKey(ROOM_MIGRATION_COMPLETE),
        dataStore = dataStore,
        defaultValue = false
    )
...
private const val ROOM_MIGRATION_COMPLETE = "roomMigrationComplete"
